...
Public Class Cr_DetalleEmpoce
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_DetalleEmpoce.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_DetalleEmpoce
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_DetalleEmpoce = New Cr_DetalleEmpoce
        rpt.Site = Me.Site
        Return rpt
    End Function
