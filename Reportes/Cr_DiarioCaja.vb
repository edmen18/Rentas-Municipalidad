...
Public Class Cr_DiarioCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_DiarioCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_DiarioCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_DiarioCaja = New Cr_DiarioCaja
        rpt.Site = Me.Site
        Return rpt
    End Function
