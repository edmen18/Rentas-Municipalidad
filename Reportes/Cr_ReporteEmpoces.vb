...
Public Class Cr_ReporteEmpoces
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_ReporteEmpoces.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_ReporteEmpoces
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_ReporteEmpoces = New Cr_ReporteEmpoces
        rpt.Site = Me.Site
        Return rpt
    End Function
