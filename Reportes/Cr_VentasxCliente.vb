...
Public Class Cr_VentasxCliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_VentasxCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_VentasxCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_VentasxCliente = New Cr_VentasxCliente
        rpt.Site = Me.Site
        Return rpt
    End Function
