...
Public Class Cr_VentasxServicio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_VentasxServicio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_VentasxServicio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_VentasxServicio = New Cr_VentasxServicio
        rpt.Site = Me.Site
        Return rpt
    End Function
